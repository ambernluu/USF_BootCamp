...
const bodyOf = document.querySelector('body');
bodyOf.prepend(newImg);
newImg.classList.add('thumbnail');

//newTodo.classList.add(boldText);
//todo.append(boldText);
// newDo.innerText = "Pet all the dogs";

// const todo = document.querySelector('ol');
// newDo.classList.add('todo');
// todo.append(newDo);
